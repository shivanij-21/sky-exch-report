...
@Component({
  selector: 'app-betgames-profitloss',
  templateUrl: './betgames-profitloss.component.html',
  styleUrls: ['./betgames-profitloss.component.scss']
})
export class BetgamesProfitlossComponent implements OnInit {
  ...
  GetProfitLoss() {
    ...
    this.reportService.CasinoBGProfitLoss(pnldates.fromdate, pnldates.todate,219921).subscribe(
      (resp: any) => {
        if (this.stype == '') {
