...
@Component({
  selector: 'app-slot-profitloss',
  templateUrl: './slot-profitloss.component.html',
  styleUrls: ['./slot-profitloss.component.scss']
})
export class SlotProfitlossComponent implements OnInit {
